...
use Dleno\CommonCore\Tools\Websocket\WsPushMsgComponent as BaseWsPushMsgComponent;

/**
 * Class WsPushMsgComponent
 * 消息推送/在线检查/关闭编排器已下沉 common-core（Dleno\CommonCore\Tools\Websocket\WsPushMsgComponent）。
