...
use Dleno\CommonCore\Websocket\Component\WsTokenComponent as BaseWsTokenComponent;

/**
 * Class WsTokenComponent
 * 连接 token / 身份绑定表已下沉 common-core（Dleno\CommonCore\Websocket\Component\WsTokenComponent）。
