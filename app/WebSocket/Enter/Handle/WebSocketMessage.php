 ...
 *
 * 路由引擎（WS-as-HTTP 适配器）+ 协议编解码已下沉 common-core（Dleno\CommonCore\Websocket\Router\WsMessageRouter
 * + Dleno\CommonCore\Websocket\Router\WsProtocol），整套归包锁死、防协议漂移、Hyperf 升级一处定点维护。
