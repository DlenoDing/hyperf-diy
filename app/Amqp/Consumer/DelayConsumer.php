...
/**
 * 【延时调用】AMQP 延时消费者示例（x-delayed-message 插件方案），与 {@see \App\Amqp\Producer\DelayProducer} 配对。
 *
...
class DelayConsumer extends BaseConsumer
{
    ...
    protected string $exchange = 'AppExampleDelayExchange';

    protected array|string $routingKey = 'AppExampleDelayRouting';

    protected ?string $queue = 'AppExampleDelayQueue';
